...
class LaratrustSetupTeams extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('auth_teams', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('auth_role_user', function (Blueprint $table) {
            ...
            $table->foreign('team_id')->references('id')->on('auth_teams')
                ->onUpdate('cascade')->onDelete('cascade');

            // Create a unique key
            $table->unique(['user_id', 'role_id', 'user_type', 'team_id'], 'auth_role_user_uput_unique');
        });

        Schema::table('auth_permission_user', function (Blueprint $table) {
           // Drop permission foreign key and primary key
            ...
            $table->unique(['user_id', 'permission_id', 'user_type', 'team_id'], 'auth_permission_user_uput_unique');
        });
    }
